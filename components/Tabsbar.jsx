...
const Tabsbar = () => {
  return (
    <div className={styles.tabs}>
      ...
      <Tab icon="/html_icon.svg" filename="about.html" path="https://blog.shameerkashif.me/resume" />
      <Tab icon="/css_icon.svg" filename="contact.css" path="/contact" />
      {/* <Tab icon="/js_icon.svg" filename="projects.js" path="/projects" /> */}
      <Tab icon="/json_icon.svg" filename="articles.json" path="https://blog.shameerkashif.me" />
